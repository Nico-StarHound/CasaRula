...
import { renderComanda, renderFactura, renderAnulacion, renderCuentaProvisional, renderRectificativa, renderReclamacion, renderCambioMesa } from './renderers.js'
  ...
  try {
    ...
    switch (job.kind) {
      ...
      case 'reclamacion':
        ...
        break
      case 'cambio_mesa':
        escpos = renderCambioMesa(job.payload)
        break
      case 'test':
